...
public partial class RiskAlerts
{
    static RiskAlerts()
    {
        // No TypeAdapterConfig needed - RiskAlertSummaryResponse uses DateTime which matches RiskAlertViewModel
    }
    ...
    {
        await DialogService.ShowAsync<RiskAlertsHelpDialog>("Risk Alert Help", new DialogParameters(), new DialogOptions
        {
