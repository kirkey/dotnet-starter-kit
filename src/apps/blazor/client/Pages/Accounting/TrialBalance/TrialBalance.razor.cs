    ...
    protected override void OnInitialized()
    {
        Context = new EntityServerTableContext<TrialBalanceSearchResponse, DefaultIdType, TrialBalanceViewModel>(
            ...
            [
                ...
                new EntityField<TrialBalanceSearchResponse>(tb => tb.PeriodStartDate, "Start Date", "PeriodStartDate"),
                new EntityField<TrialBalanceSearchResponse>(tb => tb.PeriodEndDate, "End Date", "PeriodEndDate"),
                new EntityField<TrialBalanceSearchResponse>(tb => tb.TotalDebits, "Total Debits", "TotalDebits"),
                new EntityField<TrialBalanceSearchResponse>(tb => tb.TotalCredits, "Total Credits", "TotalCredits"),
                new EntityField<TrialBalanceSearchResponse>(tb => tb.IsBalanced, "Balanced", "IsBalanced"),
                new EntityField<TrialBalanceSearchResponse>(tb => tb.Status, "Status", "Status"),
                new EntityField<TrialBalanceSearchResponse>(tb => tb.FinalizedDate, "Finalized", "FinalizedDate"),
            ],
