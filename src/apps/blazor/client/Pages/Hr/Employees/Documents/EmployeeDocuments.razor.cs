    ...
    protected override async Task OnInitializedAsync()
    {
        Context = new EntityServerTableContext<EmployeeDocumentResponse, DefaultIdType, EmployeeDocumentViewModel>(
            ...
            [
                ...
                new EntityField<EmployeeDocumentResponse>(response => response.IssueDate, "Issue Date", "IssueDate", typeof(DateTime?)),
                new EntityField<EmployeeDocumentResponse>(response => response.ExpiryDate, "Expiry Date", "ExpiryDate", typeof(DateTime?)),
                new EntityField<EmployeeDocumentResponse>(response => response.UploadedDate, "Uploaded Date", "UploadedDate", typeof(DateTime)),
            ],
