        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationalUnitId = table.Column<Guid>(type: "uuid", nullable: false),
                    MinSalary = table.Column<decimal>(type: "numeric(16,2)", precision: 16, scale: 2, nullable: true),
                    MaxSalary = table.Column<decimal>(type: "numeric(16,2)", precision: 16, scale: 2, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    TenantId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Name = table.Column<string>(type: "VARCHAR(1024)", nullable: false),
                    Notes = table.Column<string>(type: "VARCHAR(2048)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Positions_OrganizationalUnits_OrganizationalUnitId",
                        column: x => x.OrganizationalUnitId,
                        principalSchema: "humanresources",
                        principalTable: "OrganizationalUnits",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DesignationAssignments_Positions_DesignationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Positions_OrganizationalUnitId",
                schema: "humanresources",
                table: "Positions",
                column: "OrganizationalUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Positions_OrgUnitCode",
                schema: "humanresources",
                table: "Positions",
                columns: new[] { "OrganizationalUnitId", "Code" },
                unique: true);
