    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                UnitCost = table.Column<decimal>(type: "numeric(16,2)", precision: 16, scale: 2, nullable: false),
                TotalCost = table.Column<decimal>(type: "numeric(16,2)", precision: 16, scale: 2, nullable: false),
                SupplierId = table.Column<string>(type: "text", nullable: true),
                BtuContent = table.Column<decimal>(type: "numeric(16,2)", precision: 16, scale: 2, nullable: true),
                SulfurContent = table.Column<decimal>(type: "numeric(16,2)", precision: 16, scale: 2, nullable: true),
                DeliveryMethod = table.Column<string>(type: "text", nullable: true),
                IsEmergencyFuel = table.Column<bool>(type: "boolean", nullable: false),
                Name = table.Column<string>(type: "VARCHAR(1024)", nullable: false),
                Description = table.Column<string>(type: "VARCHAR(2048)", nullable: true),
                Notes = table.Column<string>(type: "VARCHAR(2048)", nullable: true),
                FilePath = table.Column<string>(type: "text", nullable: true),
