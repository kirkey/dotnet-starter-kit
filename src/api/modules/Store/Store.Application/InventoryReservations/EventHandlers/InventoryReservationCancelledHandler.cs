...
/// </remarks>
public sealed class InventoryReservationCancelledHandler : INotificationHandler<InventoryReservationCancelled>
{
    private readonly ILogger<InventoryReservationCancelledHandler> _logger;
    private readonly IRepository<InventoryTransaction> _transactionRepository;

    public InventoryReservationCancelledHandler(
