...
{
    internal static RouteHandlerBuilder MapResolveValidationIssueEndpoint(this IEndpointRouteBuilder endpoints)
    {
        return endpoints
            .MapPut("/{id:guid}/validation-issues/resolve", async (DefaultIdType id, ResolveValidationIssueCommand command, ISender mediator) =>
            {
            ...
            .WithName(nameof(ResolveValidationIssueEndpoint))
