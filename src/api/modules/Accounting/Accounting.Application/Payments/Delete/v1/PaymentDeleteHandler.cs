...
/// </summary>
public sealed class PaymentDeleteHandler : IRequestHandler<PaymentDeleteCommand>
{
    private readonly IRepository<Payment> _repository;
    private readonly ILogger<PaymentDeleteHandler> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="PaymentDeleteHandler"/> class.
    /// </summary>
    public PaymentDeleteHandler(
        IRepository<Payment> repository,
        ILogger<PaymentDeleteHandler> logger)
    {
    ...
    /// </summary>
    public async Task Handle(PaymentDeleteCommand request, CancellationToken cancellationToken)
    {
