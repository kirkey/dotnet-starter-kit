...
/// </summary>
public sealed class PaymentUpdateHandler : IRequestHandler<PaymentUpdateCommand, PaymentUpdateResponse>
{
    private readonly IRepository<Payment> _repository;
    private readonly ILogger<PaymentUpdateHandler> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="PaymentUpdateHandler"/> class.
    /// </summary>
    public PaymentUpdateHandler(
        IRepository<Payment> repository,
        ILogger<PaymentUpdateHandler> logger)
    {
    ...
    /// </summary>
    public async Task<PaymentUpdateResponse> Handle(PaymentUpdateCommand request, CancellationToken cancellationToken)
    {
