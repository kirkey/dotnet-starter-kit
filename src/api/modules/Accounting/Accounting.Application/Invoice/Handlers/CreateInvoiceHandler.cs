using Accounting.Application.Invoice.Commands;

namespace Accounting.Application.Invoice.Handlers
{
    public class CreateInvoiceHandler(IRepository<Accounting.Domain.Invoice> repository)
        : IRequestHandler<CreateInvoiceCommand, DefaultIdType>
    {
        ...
        {
            var invoice = Accounting.Domain.Invoice.Create(
