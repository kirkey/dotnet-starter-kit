...
/// <remarks>
/// Use cases:
/// - Regulatory compliance reports (Central Bank, PCFC, etc.).
/// - Portfolio at Risk (PAR) and delinquency analysis reports.
/// - Financial statements (Balance Sheet, Income Statement, Cash Flow).
/// - Operational efficiency metrics and branch performance dashboards.
/// - Loan aging analysis and collection priority reports.
/// - Scheduled automated report generation for management.
/// 
/// Default values and constraints:
/// - Code: required unique identifier, max 32 characters (example: "RPT-PAR-001")
/// - Name: required, max 128 characters (example: "Monthly PAR Report")
/// - Category: Financial, Operational, Loan, Savings, Member, Compliance
/// - OutputFormat: PDF, Excel, CSV
/// - Query: SQL or report logic, max 16384 characters
/// 
/// Business rules:
/// - Report codes must be unique.
/// - Scheduled reports run at specified intervals (daily, weekly, monthly).
/// - Access control based on user roles and branches.
/// - Report parameters validated before generation.
/// - Generated reports archived for audit purposes.
/// </remarks>
/// <seealso cref="ReportGeneration"/>
/// <seealso cref="Branch"/>
