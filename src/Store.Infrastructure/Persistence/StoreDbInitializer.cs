    ...
    StoreDbContext context) : IDbInitializer
{
    ...
    public async Task SeedAsync(CancellationToken cancellationToken)
    {
        ...
        if (existingCategories < 10)
        {
            ...
            {
                ("Uncategorized","", "UNCAT"),
                ("Beverages","Drinks and beverages", "BEV"),
                ("Bakery","Bread and baked goods", "BAK"),
                ("Dairy","Milk, cheese and yogurts", "DAI"),
                ("Produce","Fresh fruits and vegetables", "PRO"),
                ("Frozen","Frozen foods", "FRO"),
                ("Snacks","Chips, nuts, snacks", "SNK"),
                ("Household","Cleaning and household items", "HSE"),
                ("Personal Care","Toiletries and personal care", "PRC"),
                ("Health","Healthcare products", "HLT")
            };
